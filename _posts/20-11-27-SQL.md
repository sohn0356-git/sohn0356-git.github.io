...
layout: post
title:  "SQL에 대한 밍기적1"
summary: SQL SELECT에 대한 밍기적
author: GJ
date: '2020-11-27 09:53:23 +0530'
category: Data_Engineering
comment: true
tags: [, ming-gi-jeog]
thumbnail: /assets/img/posts/search.jpg
---
...
간단히 [문제](https://programmers.co.kr/learn/courses/30/lessons/59036)를 풀면서 설명해 보겠다.
...
`ANIMAL_INS`와 `ANIMAL_OUTS`를 `LEFT OUTER JOIN`하게 되면 `ANIMAL_INS`에 있고 `ANIMAL_OUTS`에 없는 데이터는 `NULL`이 들어가 있을 것이다.
